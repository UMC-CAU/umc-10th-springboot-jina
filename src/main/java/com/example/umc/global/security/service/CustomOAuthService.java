...
import com.example.umc.global.security.dto.KakaoDTO;
...
public class CustomOAuthService extends DefaultOAuth2UserService { //OAuth 과정 중 사용자 정보를 가져온 다음 실행되는 서비스
